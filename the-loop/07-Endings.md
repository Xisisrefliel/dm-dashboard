...
> Three valid endings. The party should feel like they chose, not like you steered them.

---

## Ending 1: The Village Stands Together (Diplomatic)

**Trigger:** Ilsa tells the truth to the village. Lise is found but NOT handed over. The village refuses the pact collectively.

**What happens:**

1. Ilsa walks to the square at 17:30. The players are with her. Lise is with her — the first time Lise has been outside in 6 weeks.
2. Ilsa speaks. She tells the village about the pact. About the children. About what "apprenticeship" really means. The village is horrified.
3. Mayor Carsten tries to stop her: "She's lying. The arrangement is—"
4. Dalla steps forward: "It's not a lie. I watched them walk a child east 20 years ago. I watched and I did nothing."
5. One by one, others speak. Someone's grandmother. Someone's brother. The village knows. They've always known. They just never said it out loud.
6. Ilsa holds Lise's hand and says: "The loop will not break by giving her up. It will break by refusing to give her up. Together."
7. The loop shatters. The sunrise is real. It's the first new day.

**The dragon still comes at 18:00.** But it doesn't attack. It circles once, lands in the square, and speaks:

> "The pact is broken. The tribute is refused. I will not collect what is not given. But remember — the protection ends as well. You are on your own."
...
## Ending 2: The Dragon Falls (Combat)

**Trigger:** The party kills the dragon in a prepared fight, using knowledge and prep from across loops.
...
- Gold, gems, art — a dragon's hoard. Worth ~2,000g.
- A +1 shield with the old village crest (the original pact artifact, now inert and cold).
...
## Ending 3: New Terms (Renegotiation)

**Trigger:** The party approaches the dragon at the ridge during the day (loop 4+), learned the truth about the pact, and offers alternative terms.

**What happens:**

1. The party reaches the ridge. The dragon is awake, watching them. It doesn't attack. It speaks first:

> "You come without steel. Unusual. What do you want?"

2. The party must explain that they know about the pact. They must offer new terms. The dragon is a contract-bound creature — it respects counter-offers. But it won't accept just anything.

**What the dragon will accept:**
- **Gold or treasure** equal to what it would gain from a lifetime of a firstborn's labor. (The players can pool party gold, raid the dragon's own advice on what it values, or offer the village's treasury if the mayor agrees.)
- **A service instead of a person.** Aldric could forge for the dragon. A spellcaster could owe it a favor. The players themselves could promise to return every 20 years and render a service.
...
**Epilogue:** The dragon leaves. It will return in 20 years for the new terms. The village is still under a pact — but a better one. The players have given Ashen a generation to figure out a permanent solution. Or they can promise to come back and deal with it then.

**Why this ending works:** It requires the party to negotiate with a creature they've been fearing for 5 loops. It requires understanding what the dragon wants (not children specifically — tribute, of equivalent value). And it doesn't let the village off the hook — they're still bound, just on better terms.
