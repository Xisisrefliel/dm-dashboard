      ...
      <div style={{ ...styles.root, height: "auto", minHeight: "100vh", overflow: "visible" }}>
        ...
        <div style={{ maxWidth: 800, margin: "0 auto", padding: "24px 20px" }}>
          ...
          {(() => {
            ...
            const allEquip = [
              ...char.equipment.map((id) => equipmentOptions.find((e) => e.id === id)).filter(Boolean),
              ...(char.inventory || []),
            ];
              ...
              <div style={{ flex: 1, overflowY: "auto", padding: "16px 20px" }}>
                {openPanel === "inventory" && (() => {
                  ...
                  const allItems = [
                    ...char.equipment.map((id) => {
                      const eq = equipmentOptions.find((e) => e.id === id);
                      return eq ? { ...eq, source: "equipment" } : null;
                    }).filter(Boolean),
                            ...
                            <div key={item.id + "-" + i} style={{
                              ...
                              <Ripple onClick={() => {
                                if (item.source === "equipment") {
                                  update("equipment", char.equipment.filter((id) => id !== item.id));
                                } else {
                                  removeItem(i - char.equipment.length);
                                }
                              }} style={{
                                width: 32, height: 32, borderRadius: 10,
                                display: "flex", alignItems: "center", justifyContent: "center",
