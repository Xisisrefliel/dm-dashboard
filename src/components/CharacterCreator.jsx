...
import {
  ...
  RACE_ICONS,
  CLASS_ICONS,
} from "../data/character-constants.js";
import { CLASS_STARTING_EQUIPMENT } from "../data/class-starting-equipment.js";
import { styles, ms } from "./character-creator/styles.js";
import SummaryRow from "./character-creator/cards/SummaryRow.jsx";
import CharacterList from "./CharacterList.jsx";
import CharacterSheet from "./CharacterSheet.jsx";
import RaceStep from "./character-creator/steps/RaceStep.jsx";
import ClassStep from "./character-creator/steps/ClassStep.jsx";
import BackgroundStep from "./character-creator/steps/BackgroundStep.jsx";
import StatsStep from "./character-creator/steps/StatsStep.jsx";
import AlignmentStep from "./character-creator/steps/AlignmentStep.jsx";
import EquipmentStep from "./character-creator/steps/EquipmentStep.jsx";
import SpellsStep from "./character-creator/steps/SpellsStep.jsx";
...
function CharacterCreator({
  ...
  const initStats = () => {
    ...
    if (saved?.assignedStats && Object.keys(saved.assignedStats).length === 6)
      return saved.assignedStats;
