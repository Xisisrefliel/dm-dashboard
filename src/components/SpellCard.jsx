import { spellsData, LEVEL_LABELS, SCHOOL_ICONS } from "./SpellList.jsx";

export default function SpellCard({ spellId, Icon, Ripple, renderMarkdown, onPin, isPinned }) {
  ...
  const pinId = `srd-spell-${spell.id}`;
