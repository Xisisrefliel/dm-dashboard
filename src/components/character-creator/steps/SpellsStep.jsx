...
import SpellRow from "../cards/SpellRow.jsx";

export default function SpellsStep({ char, update, isMobile: isMobileProp, haptic, spellSlots, hasSpellcasting, classData }) {
