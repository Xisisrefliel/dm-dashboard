...
import { ABILITIES, ABILITY_NAMES, ABILITY_ICONS, POINT_BUY_COSTS, POINT_BUY_TOTAL } from "../../../data/character-constants.ts";
import type { Character, AbilityScores, AbilityKey, SrdClass, SrdRace } from "../../../types/index.ts";
...
interface Props {
  ...
  adjustStat: (ability: AbilityKey, delta: number) => void;
  rollStats: () => void;
  statMode: string;
  switchStatMode: (mode: string) => void;
  getRacialBonus: (ability: AbilityKey) => number;
  raceData: SrdRace | null;
            ...
            >
              ...
              <div style={{ flex: 1, display: "flex", alignItems: "center", gap: 10 }}>
                <div style={{
                  ...
                  <Icon name={ABILITY_ICONS[ab] ?? "person"} size={20} style={{ color: "var(--dm-primary)" }} />
                </div>
                <div>
