...
import { ALIGNMENTS } from "../../../data/character-constants.js";

export default function AlignmentStep({ char, update, next, isMobile: isMobileProp, haptic, selectAndAdvance, quizQuestions, quizAnswers, quizDone, suggestedAlignment, answerQuiz, resetQuiz }) {
