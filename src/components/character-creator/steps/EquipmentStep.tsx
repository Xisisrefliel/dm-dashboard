...
import type { Character, SrdClass, ClassEquipmentConfig } from "../../../types/index.ts";

interface Props {
  char: Character;
  isMobile?: boolean;
  haptic: { trigger: (type: string) => void };
  classEquipConfig: ClassEquipmentConfig | null;
  selectEquipChoice: (choiceIdx: number, optionId: string | undefined) => void;
  classData: SrdClass | null;
}

export default function EquipmentStep({ char, isMobile: isMobileProp, haptic, classEquipConfig, selectEquipChoice, classData }: Props) {
