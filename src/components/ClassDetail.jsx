import { classesData, CLASS_ICONS } from "./ClassList.jsx";

export default function ClassDetail({ classId, Icon, Ripple, onPin, isPinned }) {
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16 }}>
          ...
          <div>
            ...
            <div style={{ fontSize: 13, color: "var(--dm-text-muted)", fontStyle: "italic" }}>
              Hit Die: d{cls.hitDie} &bull; {cls.spellcasting ? `${cls.spellcasting.ability} caster` : "Non-caster"}
            </div>
          </div>
        </div>
        ...
        <div style={{ borderTop: "1px solid var(--dm-primary-dim)", borderBottom: "1px solid var(--dm-primary-dim)", padding: "12px 0", marginBottom: 12 }}>
          ...
          {cls.spellcasting && (
            <div style={{ fontSize: 13, color: "var(--dm-text-secondary)", padding: "2px 0" }}>
              ...
              {cls.spellcasting.ability} (from level {cls.spellcasting.level})
            </div>
          )}
        </div>
